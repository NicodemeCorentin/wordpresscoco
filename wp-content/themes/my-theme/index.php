...
?>
  <section class="section-1">
    ...
    <h1 class="Titre"> Chaine alimentaire végétale et durabilité:</h1>
    <h1 class="Titre-green">Une question d'équilibre</h1>
    <a class="button" href="#">s'inscrire aux rencontres</a>
  </section>
